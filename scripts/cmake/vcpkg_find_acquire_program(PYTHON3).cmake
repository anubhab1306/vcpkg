if(CMAKE_HOST_WIN32)
    ...
    set(disambiguator "-1")
    set(tool_subdirectory "${tool_subdirectory}${disambiguator}")
    ...
    vcpkg_list(SET post_install_command "${CMAKE_COMMAND}" "-DPYTHON_DIR=${paths_to_search}" "-DVERSION=${program_version}" -P "${CMAKE_CURRENT_LIST_DIR}/z_vcpkg_make_python_less_embedded.cmake")
else()
